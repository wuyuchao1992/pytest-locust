...
class Config:
    ...
    VALUE_HOST = "host"
    VALUE_ADMIN_LOGIN_HOST = "admin_loginHost"
    VALUE_SHOP_LOGIN_HOST = "shop_loginHost"
    VALUE_ADMIN_LOGIN_INFO = "admin_loginInfo"
    VALUE_SHOP_LOGIN_INFO = "shop_loginInfo"
    # [mail]
    ...
    def __init__(self):
        ...
        self.admin_loginHost_debug = self.get_conf(Config.TITLE_DEBUG, Config.VALUE_ADMIN_LOGIN_HOST)
        self.shop_loginHost_debug = self.get_conf(Config.TITLE_DEBUG, Config.VALUE_SHOP_LOGIN_HOST)

        self.admin_loginInfo_debug = self.get_conf(Config.TITLE_DEBUG, Config.VALUE_ADMIN_LOGIN_INFO)
        self.shop_loginInfo_debug = self.get_conf(Config.TITLE_DEBUG, Config.VALUE_SHOP_LOGIN_INFO)
        ...
        self.admin_loginHost_release = self.get_conf(Config.TITLE_RELEASE, Config.VALUE_ADMIN_LOGIN_HOST)
        self.shop_loginHost_release = self.get_conf(Config.TITLE_RELEASE, Config.VALUE_SHOP_LOGIN_HOST)

        self.admin_loginInfo_release = self.get_conf(Config.TITLE_RELEASE, Config.VALUE_ADMIN_LOGIN_INFO)
        self.shop_loginInfo_release = self.get_conf(Config.TITLE_RELEASE, Config.VALUE_SHOP_LOGIN_INFO)
